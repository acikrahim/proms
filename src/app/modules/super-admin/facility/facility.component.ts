...
import { ErrorHandlingService, FacilityService, ModalService, PropertyService, UnitService } from 'src/app/services';
import { Property, Unit } from 'src/app/models/interfaces';
import cash from 'cash-dom';

@Component({
    selector: 'admin-facility',
...
export class FacilityComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.facility.getComponents().subscribe({
            next: (response: any) => {
    ...
    public propertyChanged(property: Property) {
        this.facility.getFacilities(property).subscribe({
